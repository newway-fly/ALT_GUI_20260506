...
class MainCB(QWidget):
    ...
    def _trigger_bulk_read(self, action_type):
        ...
        if action_type == 'NOISE':
            self.ctrl.send_cmd(CmdType.GET_PD_ADC_DATA, wait_for_ack=False)
